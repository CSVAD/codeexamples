...
void setupGUI(){
  ...
  sliders[si++] = controlP5.addSlider("dandelionCount",1,15,left,top+posY+0,len,15);
  posY += 30;

  sliders[si++] = controlP5.addSlider("seedCount",20,100,left,top+posY+0,len,15);
  sliders[si++] = controlP5.addSlider("rotationVariance",10,100,left,top+posY+20,len,15);
  sliders[si++] = controlP5.addSlider("velocityScaling",10,100,left,top+posY+20,len,15);
